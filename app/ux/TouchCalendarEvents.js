 ...
 */
/**
 * @class eAlmanac.ux.TouchCalendarEvents
 * @author Stuart Ashworth
 *
 * For use with Sencha Touch 2
 * 
 * This plugin also allows a store to be bound to the CalendarSencha.ux.TouchCalendar and will display the store's events as bars spanning its relevant days. 
 * 
 * ![CalendarSencha.ux.TouchCalendarEvents Screenshot](http://www.swarmonline.com/CalendarSencha.ux.TouchCalendar/screenshots/CalendarSencha.ux.TouchCalendarEvents--month-ss.png)
 * 
 * [CalendarSencha.ux.TouchCalendarEvents Demo](http://www.swarmonline.com/CalendarSencha.ux.TouchCalendar/examples/CalendarSencha.ux.TouchCalendarEvents.html)
 * 
 */
Ext.define('CalendarSencha.ux.TouchCalendarEvents', {
	...
	getViewModeProcessorClass: function(viewMode){
		...
		switch(viewMode.toLowerCase()){
			...
			case 'month':
				processorCls = 'CalendarSencha.ux.TouchCalendarMonthEvents';
				break;

			case 'week':
				processorCls = 'CalendarSencha.ux.TouchCalendarWeekEvents';
				break;

			case 'day':
				processorCls = 'CalendarSencha.ux.TouchCalendarDayEvents';
				break;
		}
 ...
 * @private
 */
Ext.define("CalendarSencha.ux.CalendarEventBarModel", {
  extend: "Ext.data.Model",
	config: {
	  ...
	  hasMany: [{
	      model: 'CalendarSencha.ux.CalendarEventBarModel',
	      name: 'linked'
	  }]
	}
});
...
Ext.define('CalendarSencha.util.Region.partial', {
