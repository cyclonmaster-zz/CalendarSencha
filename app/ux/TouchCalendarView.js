 ...
 */
/**
 * @class CalendarSencha.ux.TouchCalendarView
 * @author Stuart Ashworth
 *
 * For use with Sencha Touch 2
 *
 */
Ext.define('CalendarSencha.ux.TouchCalendarView', {
	...
	applyViewMode: function(viewMode){
        ...
        var viewModeFns = CalendarSencha.ux.TouchCalendarView[viewMode.toUpperCase()];
	...
	statics: {
		...
		MONTH: {
				...
				getStartDate: function(date){
					return Ext.bind(CalendarSencha.ux.TouchCalendarView.WEEK.getStartDate, this)(new Date(date.getFullYear(), date.getMonth(), 1));
				},
